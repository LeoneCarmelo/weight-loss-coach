...
<div class="container p-5">
    ...
    <div class="row flex-column align-items-center">
        ...
        <form action="{{route('measurements.store')}}" method="post" class="d-flex bg-dark gap-3 p-3 my-3 rounded-3 w-50">
            @csrf
            <td>
                <div class="d-flex flex-column gap-2">
                    <label for="weight_kg" class="text-light">Weight Kg</label>
                    <input type="number" name="weight_kg" class="form-control @error('date_of_birth') is-invalid @enderror">
                </div>
            </td>
            <td>
                <div class="d-flex flex-column gap-2">
                    <label for="fat_percentage" class="text-light">Fat Percentage</label>
                    <input type="number" name="fat_percentage" class="form-control @error('date_of_birth') is-invalid @enderror">
                </div>
            </td>
            <td>
                <div class="d-flex flex-column gap-2">
                    <label for="blood_pressure" class="text-light">Blood Pressure</label>
        ...
        <div class="table-responsive w-50 rounded-2">
